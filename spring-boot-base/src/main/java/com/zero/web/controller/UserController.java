...
public class UserController {
    ...
    public ReturnVo<List<User>> listUserInfo(
    ...
    @ApiOperation("获取用户信息")
    public ReturnVo<ShiroUserVo> getUserInfo() throws Exception {
        return ReturnVo.success(UserContextHelper.getUser());
    }

    @PostMapping(value = "/check.json")
    @ApiOperation("签到")
    public BaseReturnVo check() throws Exception {
    ...
    @ApiOperation("查看签到记录")
    public ReturnVo<CheckRecordVo> queryCheckRecord() throws Exception {
